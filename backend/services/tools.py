...
async def execute_tool(name: str, arguments: dict, db: AsyncSession, user=None, session_id: str | None = None) -> str:
    ...
    try:
        result = await handler(arguments, db, user, session_id=session_id)
